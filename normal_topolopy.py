...
if __name__=="__main__":
    ...
    # start network
    net.start()
    sstart_new_thread(hostRunCMD, (h11,"nc -w 750 -lup 9696",))
    from time import sleep
    sleep(0.5)
    start_new_thread(hostRunCMD, (h1,"nc -u 10.0.0.11 9696 -w 50",))
    start_new_thread(hostRunCMD, (h2,"nc -u 10.0.0.11 9696 -w 50",))
    start_new_thread(hostRunCMD, (h3,"nc -u 10.0.0.11 9696 -w 50",))
    start_new_thread(hostRunCMD, (h4,"nc -u 10.0.0.11 9696 -w 50",))
    start_new_thread(hostRunCMD, (h5,"nc -u 10.0.0.11 9696 -w 50",))
    start_new_thread(hostRunCMD, (h6,"nc -u 10.0.0.11 9696 -w 50",))
    start_new_thread(hostRunCMD, (h7,"nc -u 10.0.0.11 9696 -w 50",))
    start_new_thread(hostRunCMD, (h8,"nc -u 10.0.0.11 9696 -w 50",)) # attack host
    start_new_thread(hostRunCMD, (h9,"nc -u 10.0.0.11 9696 -w 50",))
    start_new_thread(hostRunCMD, (h10,"nc -u 10.0.0.11 9696 -w 50",))
    start_new_thread(hostRunCMD, (h12,"nc -u 10.0.0.11 9696 -w 50",))
    start_new_thread(hostRunCMD, (h13,"nc -u 10.0.0.11 9696 -w 50",))
    start_new_thread(hostRunCMD, (h14,"nc -u 10.0.0.11 9696 -w 50",))
    start_new_thread(hostRunCMD, (h15,"nc -u 10.0.0.11 9696 -w 50",))
    start_new_thread(hostRunCMD, (h16,"nc -u 10.0.0.11 9696 -w 50",))
    CLI(net)
    # stop network
    net.stop()